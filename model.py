...
class YOLOv8OBBModel(LabelStudioMLBase):
    def __init__(self, **kwargs):
        ...
        # Load your trained YOLOv8 OBB model weights here
        self.model = YOLO('models/pre-trained/ulangn-obb_v2-0.pt') 
        
        # Automatically grab the label setup from your Label Studio project UI
        self.from_name, self.to_name, self.value, self.labels = self.get_first_tag_keys(
    ...
    def predict(self, tasks, **kwargs):
        ...
        for task in tasks:
                ...
                for obb in r.obb:
                    ...
                    result_boxes.append({
                        ...
                        'value': {
                            ...
                            'width': ls_w,
                            'height': ls_h,
                            'rotation': ls_rotation # Added the required rotation property
                        },
                        'score': conf
                    })
            ...
            predictions.append({
                'result': result_boxes,
                'model_version': 'yolov8-obb-ulang-v1'
            })
